      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-gray-50 rounded-lg shadow-sm border border-gray-200">
          <div className="flex border-b border-gray-200">
            <button
              className={`flex-1 py-3 px-4 text-sm font-medium text-gray-700 transition-colors duration-200 ${
                ...
                <div>
                  ...
                  <ol className="ml-6 space-y-2 text-gray-600 list-decimal">
                    ...
                    <li className="flex items-center">
                      ...
                      <img src="/src/assets/1st-attempt/1.jpg" alt="Step 1" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                    <li className="flex items-center">
                      <span className="mr-2">Cover the mixture with another oil paper on top.</span>
                      <img src="/src/assets/1st-attempt/2.jpg" alt="Step 2" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                    <li className="flex items-center">
                      <span className="mr-2">Let the mixture set for 3 days at room temperature.</span>
                      <img src="/src/assets/1st-attempt/3.jpg" alt="Step 3" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                    <li className="flex items-center">
                      <span className="mr-2">Place the mixture in the sun to test if it melts (it melted quickly).</span>
                      <img src="/src/assets/1st-attempt/4.jpg" alt="Step 4" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                  </ol>
                </div>
                <div>
                ...
                <div>
                  ...
                  <ol className="ml-6 space-y-2 text-gray-600 list-decimal">
                    ...
                    <li className="flex items-center">
                      ...
                      <img src="/src/assets/2nd-attempt/1.jpg" alt="Step 1" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                    <li className="flex items-center">
                      <span className="mr-2">Let the mixture set for 3 days at room temperature.</span>
                      <img src="/src/assets/2nd-attempt/2.jpg" alt="Step 2" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                  </ol>
                </div>
                <div>
                ...
                <div>
                  ...
                  <ol className="ml-6 space-y-2 text-gray-600 list-decimal">
                    ...
                    <li className="flex items-center">
                      ...
                      <img src="/src/assets/3rd-attempt/2.jpg" alt="Step 2" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                    <li className="flex items-center">
                      <span className="mr-2">Remove from heat, let it cool slightly, and stir in 60 ml of liquid latex until smooth.</span>
                      <img src="/src/assets/3rd-attempt/3.jpg" alt="Step 3" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                    <li className="flex items-center">
                    ...
                    <li className="flex items-center">
                      ...
                      <img src="/src/assets/3rd-attempt/4.jpg" alt="Step 4" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                    <li className="flex items-center">
                      <span className="mr-2">Observe the final result.</span>
                      <img src="/src/assets/3rd-attempt/5.jpg" alt="Step 5" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                    <li className="flex items-center">
                      <span className="mr-2">Check an additional view of the result.</span>
                      <img src="/src/assets/3rd-attempt/6.jpg" alt="Step 6" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                  </ol>
                </div>
                <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <ol className="ml-6 space-y-2 text-gray-600 list-decimal">
                    ...
                    <li className="flex items-center">
                      <span className="mr-2">Pour the mixture into a paper-lined tray.</span>
                      <img src="/src/assets/4th-attempt/1.jpg" alt="Step 1" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                    <li className="flex items-center">
                ...
                <div>
                  ...
                  <ol className="ml-6 space-y-2 text-gray-600 list-decimal">
                    ...
                    <li className="flex items-center">
                      ...
                      <img src="/src/assets/5th-attempt/1.jpg" alt="Step 1" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                    <li className="flex items-center">
                      <span className="mr-2">Note the beeswax rising to the top while the underneath mixture remains gel-like.</span>
                      <img src="/src/assets/5th-attempt/2.jpg" alt="Step 2" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                    <li className="flex items-center">
                      <span className="mr-2">Let the mixture set in the same pan for 2 days.</span>
                      <img src="/src/assets/5th-attempt/3.jpg" alt="Step 3" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                    <li className="flex items-center">
                      <span className="mr-2">Check an additional view of the result.</span>
                      <img src="/src/assets/5th-attempt/4.jpg" alt="Step 4" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                  </ol>
                </div>
                <div>
                ...
                <div>
                  ...
                  <ol className="ml-6 space-y-2 text-gray-600 list-decimal">
                    ...
                    <li className="flex items-center">
                      ...
                      <img src="/src/assets/6th-attempt/1.jpg" alt="Step 1" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                    <li className="flex items-center">
                      <span className="mr-2">Let it set for 2 days.</span>
                      <img src="/src/assets/6th-attempt/2.jpg" alt="Step 2" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                    <li className="flex items-center">
                      <span className="mr-2">Remove the hardened mixture from the tray.</span>
                      <img src="/src/assets/6th-attempt/3.jpg" alt="Step 3" className="w-32 h-auto rounded shadow-sm" />
                    </li>
                  </ol>
                </div>
                <div>
